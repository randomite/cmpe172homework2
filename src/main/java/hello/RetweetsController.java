...
public class RetweetsController {
    ...
    @GetMapping("/retweets")
    public String retweets(@RequestParam(name="name", required=false, defaultValue="World") String name, Model model) throws TwitterException {
    	...
    	ResponseList<Status> responses = twitter.getRetweetsOfMe();
